...
<html xmlns="http://www.w3.org/1999/xhtml" style="overflow:hidden;">
	...
	window.location.href = "./frontstage/login.jsp";
		...
		<script type="text/javascript"
			src="./scripts/frontstage/userinfo/userinfo.js"></script>

 		 <script type='text/javascript' src='/weibo/dwr/engine.js'></script>
 		 <script type='text/javascript' src='/weibo/dwr/interface/UserinfoService.js'></script>
					...
					<form method="POST" id="infoForm"
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<input class="hasDatepicker" name="trueName" value="<s:property value="#request.userinfo.trueName"/>"
									id="trueName" type="text">
						...
						<div class="control-group">
							...
							<div class="controls">
								<label class="radio inline">
								    <s:if test='#request.userinfo.sex==0'>
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<input class="" name="birthday" value="<s:date name="#request.userinfo.birthday" format="yyyy-MM-dd" />"
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<input class="hasDatepicker" name="work"  id="work" value="<s:property value="#request.userinfo.work"/>"
									type="text">
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<textarea name="comment" id='comment' rows="3" ><s:property value="#request.userinfo.comment"/></textarea>
						...
						<div class="form-actionss">
							<input name="id" id="userinfoId"  type="hidden" value="<s:property value="#request.userinfo.id"/>"/>
