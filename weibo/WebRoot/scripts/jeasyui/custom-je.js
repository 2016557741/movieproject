...
function setObjName(obj) {
    ...
    _delurl = "./csdn/" + _actionName + "_deleteObject.action";
    _saveorupdateurl = "./csdn/" + _actionName + "_saveOrUpdateObject.action";
    _queryurl = "./csdn/" + _actionName + "_query.action?nowtime=" + new Date().getTime();
}
...
function _getComboboxData(obj) {
    ...
    return "./csdn/" + _actionName + "_" + _ajaxan + ".action?nowtime=" + new Date().getTime();
}

function _getAjaxData(obj) {

    var _ajaxan = "getAll" + obj.substring(0, 1).toUpperCase() + obj.substring(1);
    _comboboxurl = "./csdn/" + _actionName + "_" + _ajaxan + ".action?nowtime=" + new Date().getTime();
    /*
        ...
        init : function(container, options) {
            ...
            if (options.ajaxCheck != null) {
                ...
                $(input).blur(function() {
                    ...
                    $.post("./csdn/" + _actionName + "_check" + _checkFieldName + ".action", _checkParam, function(data) {
