...
<html>
  ...
  <body>
    <header>
       <div class="logo"><i class="fa fa-ul fa-cutlery"></i>Movie</div>	    
    </header>  
    <main class="bg">
    
	  <!-- <s:form action="user/user_login" method="post" cssClass="login" validate="true">
	      <h3>请您登录</h3>
	      <div class="form-group">
              ...
              <div class="input-group">
                ...
                <!--<input type="text" name="user.name" pattern="^[a-zA-Z]\w{5,15}$" class="form-control" placeholder="请输入用户名" required>  -->
                <!--<input type="email" name="user.name" class="form-control" placeholder="请输入您的邮箱" required>  -->
                <!--<input type="text" name="user.name" class="form-control" placeholder="请输入用户名" required>  -->
             <!--  </div>
              <div class="input-group">
              ...
              <div class="input-group">
                ...
                <input type="text" name="user.address" class="form-control" placeholder="请输入您的地址">
              </div>
          </div>
